 ...
 * @details Предоставляет конкретную реализацию интерфейса IRegistryParser.
 * Использует библиотеку libregf для открытия и анализа файлов реестра Windows.
*/
 ...
 * @details Предоставляет методы для открытия файлов реестра, извлечения значений ключей
 * и конкретных значений по имени. Работает с библиотекой libregf.
*/
class RegistryParser : public IRegistryParser {
  ...
  */
  ...
  /**
   * @brief Деструктор.
   * @details Освобождает ресурсы, связанные с libregf.
  */
   ...
   * @throw FileOpenError Если файл не удалось открыть.
  */
